...
description: Zorg ervoor dat alle noodzakelijke stappen voor het laden van de Adobe Experience Platform Web SDK in de juiste volgorde worden uitgevoerd.
feature: APIs/SDKs
level: Experienced
role: Developer
hide: true
...
![SDKs-diagram initialiseren](/help/dev/patterns/assets/diagram-initiaze-sdk.png){width="600" zoomable="yes"}
...
![SDK-diagram voor Bezoeker-API laden](/help/dev/patterns/assets/load-visitor-api-sdk.png){width="100" zoomable="yes"}

**Vereisten**

* Als u de Bezoeker-id/API-service wilt gebruiken, moet uw bedrijf zijn ingeschakeld voor de [!DNL Adobe Experience Cloud] en een [!UICONTROL Organization ID]. Zie voor meer informatie [Experience Cloud-vereisten: organisatie-id](https://experienceleague.adobe.com/docs/id-service/using/reference/requirements.html?){target=_blank} in de *Help bij Identiteitsservice* hulplijn.
...
Zie voor meer informatie [Voer de Dienst van Experience Cloud voor Doel uit](https://experienceleague.adobe.com/docs/id-service/using/implementation/setup-target.html){target=_blank}.

**Leesingen**

* [Overzicht van Experience Cloud-identiteitsservice](https://experienceleague.adobe.com/docs/id-service/using/intro/overview.html){target=_blank}
* [Over de id-service](https://experienceleague.adobe.com/docs/id-service/using/intro/about-id-service.html){target=_blank}
* [Cookies en de Experience Cloud Identity Service](https://experienceleague.adobe.com/docs/id-service/using/intro/cookies.html){target=_blank}
* [Hoe de Dienst van de Identiteit van de Experience Cloud verzoekt en identiteitskaart plaatst](https://experienceleague.adobe.com/docs/id-service/using/intro/id-request.html){target=_blank}
* [ID-synchronisatie en overeenkomsten](https://experienceleague.adobe.com/docs/id-service/using/intro/match-rates.html){target=_blank}
...
![Klant-id instellen](/help/dev/patterns/assets/set-customer-id.png){width="100" zoomable="yes"}
...
![Automatische aanvraag voor het laden van pagina&#39;s configureren](/help/dev/patterns/assets/configure-automatic-page-request.png){width="100" zoomable="yes"}
...
![Flikkeringsdiagram configureren](/help/dev/patterns/assets/flicker-handling.png){width="100" zoomable="yes"}
...
![Gegevenstoewijzingsdiagram](/help/dev/patterns/assets/data-mapping.png){width="100" zoomable="yes"}
...
![Extern gegevenstoewijzingsdiagram](/help/dev/patterns/assets/remote-data-mapping.png){width="100" zoomable="yes"}
...
![Adobe Target Web SDK-diagram laden](/help/dev/patterns/assets/load-web-sdk.png){width="100" zoomable="yes"}
