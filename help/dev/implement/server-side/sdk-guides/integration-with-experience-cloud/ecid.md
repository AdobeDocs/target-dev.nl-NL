...
Integraties in ECID, [!DNL Analytics], en [!DNL Target] geen speciale verwerking voor analyses aan de serverzijde vereist. Voeg in plaats daarvan, zodra u de ECID hebt geïntegreerd, `AppMeasurement.js` ([!DNL Analytics] bibliotheek) aan de clientzijde. [!DNL Analytics] gebruikt u vervolgens de instantie Visitor om te synchroniseren met [!DNL Target].
