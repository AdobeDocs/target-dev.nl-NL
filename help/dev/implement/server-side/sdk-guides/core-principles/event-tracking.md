...
description: Gebruiken [!DNL Adobe Target]De mogelijkheden van het gebeurtenisvolgen om metriek effectief te meten die het belangrijkst voor uw zaken en gebruiksgevallen zijn.
...
1. Een [!DNL Adobe Target] activiteit met een doel metrisch in UI.
   ...
   ![alternatieve afbeelding](./assets/report-settings.png)
