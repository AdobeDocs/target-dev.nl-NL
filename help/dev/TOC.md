...
+ Implementatie op de client {#client-side}
   ...
   + Adobe Experience Platform Web SDK-implementatie {#aep}
      ...
      + [Reactieknoppen openen](/help/dev/implement/client-side/aep-web-sdk/accessing-response-tokens.md)
      + [use mbox3rdPartyId](/help/dev/implement/client-side/aep-web-sdk/using-mbox-3rdpartyid.md)
      + [Vergelijk de bibliotheek at.js met het Web SDK van het Platform](/help/dev/implement/client-side/aep-web-sdk/web-sdk-atjs-comparison.md)
